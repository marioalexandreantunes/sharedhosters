...
<sub>Atenção se o teu projecto de django precisar cache com `redis`, localcalmente não está disponível, podes usar remotamente grátis de `redislabs.com` ou `upstash.com`.<br />
